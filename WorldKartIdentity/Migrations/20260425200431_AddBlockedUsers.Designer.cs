...
namespace WorldKartIdentity.Migrations
{
    ...
    [Migration("20260425200431_AddBlockedUsers")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WorldKartIdentity.Database.BlockedUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WorldKartIdentity.Database.BlogReport", b =>
                {
                    b.Property<int?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WorldKartIdentity.Database.FavoriteBlog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("FavoriteBlogs", (string)null);
                });
            ...
            modelBuilder.Entity("WorldKartIdentity.Database.TrackAnnotation", b =>
                {
                    ...
                    b.Property<string>("AnnotationJsonId")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("WorldKartIdentity.Database.TrackTrajectory", b =>
                {
                    ...
                    b.Property<string>("TrajectoryBase64")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("WorldKartIdentity.Database.BlogReport", b =>
                {
                    ...
                    b.HasOne("WorldKartIdentity.Database.User", "Reporter")
                        .WithMany()
